                ...
                <div class="col-xs-12">
                            ...
                            <div class="row form-horizontal">
                                ...
                                <div class="col-xs-12 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="subTitle" placeholder="子标题" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="titleDesc" placeholder="标题描述" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="bo-body">
                            ...
                            <button  type="button" class="btn btn-sm btn-default" onclick="Icheck.deleteMulti('/content/deleteMulti')"><i class="fa fa-trash-o">删除</i></button>&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        ...
        _dataTable=Icheck.initDataTables("/content/page",columns);
    });
    function search(){
        var title=$("#title").val();
